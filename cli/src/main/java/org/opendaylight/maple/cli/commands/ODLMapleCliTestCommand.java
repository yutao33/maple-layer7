 ...
 */
package org.opendaylight.maple.cli.commands;
...
public class ODLMapleCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(ODLMapleCliTestCommand.class);
    protected final ODLMapleCliCommands service;

    public ODLMapleCliTestCommand(final ODLMapleCliCommands service) {
